...
public class Demo {
    ...
    private FoyaHttpServer server;
    private FoyaHttpClient client;

    @Before
    public void initServer() throws Exception {
        this.server = new FoyaHttpServer();
        this.server.setTimeout(5000);
    }

    @Before
    public void initClient() throws Exception {
        this.client = new FoyaHttpClient();
    ...
    public void testHttpPostNoContentLength() throws Exception {
        ...
        try {
            ...
            this.client = new FoyaHttpClient(new ImmutableHttpProcessor(
