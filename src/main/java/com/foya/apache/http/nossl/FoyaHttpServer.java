...
public class FoyaHttpServer {
	...
	public FoyaHttpServer() throws IOException {
		super();
	...
	public void start() throws IOException {
		...
		this.server = ServerBootstrap.bootstrap().setListenerPort(9999).setSocketConfig(SocketConfig.custom().setSoTimeout(this.timeout).build())
	...
	static class SimpleExceptionLogger implements ExceptionLogger {
		...
		private final Log log = LogFactory.getLog(FoyaHttpServer.class);
