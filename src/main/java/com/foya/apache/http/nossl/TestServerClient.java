...
public class TestServerClient {
	...
	private FoyaServer server;
	private FoyaClient client;

	@Before
	public void initServer() throws Exception {
		this.server = new FoyaServer("127.0.0.1", 30008);
		this.server.setTimeout(5000);
	}

	@Before
	public void initClient() throws Exception {
		this.client = new FoyaClient();
	...
	public void testSimpleHttpPostsHTTP10() throws Exception {
		...
		try {
			for (int r = 0; r < reqNo; r++) {
				...
				final BasicHttpEntityEnclosingRequest post = new BasicHttpEntityEnclosingRequest("POST", "/", HttpVersion.HTTP_1_0);
				final byte[] data = testData.get(r);
				final ByteArrayEntity outgoing = new ByteArrayEntity(data);
				post.setEntity(outgoing);
	...
	public void testHttpPostNoContentLength() throws Exception {
		...
		try {
			...
			this.client = new FoyaClient(new ImmutableHttpProcessor(new HttpRequestInterceptor[] { new RequestTargetHost(),
					new RequestConnControl(), new RequestUserAgent(), new RequestExpectContinue(true) }));
	...
	public void testHttpPostIdentity() throws Exception {
		...
		try {
			...
			this.client = new FoyaClient(new ImmutableHttpProcessor(new HttpRequestInterceptor[] { new HttpRequestInterceptor() {
